...
function load_settings(){
    ...
    $.ajax({
        url: "/superadmin/fantree/settings/"+fantree_id,
        type: 'GET',
        dataType: 'json',
...
function editChartStatus() {
    ...
    if(translateX != null && translateY != null && scale != null){
        ...
        let fantree_id = get_fantree_id()
        $.ajax({
            url: "/superadmin/fantree/editchartstatus/"+fantree_id,
            type: 'POST',
            data: {
...
function applyChartStatus() {
    ...
    $.ajax({
        url: '/superadmin/fantree/getchartstatus/'+fantree_id,
        method: 'GET',
        success: function (data) {
            if (data.error == false) {
...
function update_count(indis,generation){
    ...
    let fantree_id = get_fantree_id()
    $.ajax({
        url: "/superadmin/fantree/updatecount/"+fantree_id,
        type: 'POST',
        data: {
            'stats': stats
        },
