...
document.getElementById('save_image').addEventListener('click', function () {
    ...
    // open the request to the "/superuser/fantree/saveimage" url
    request.open("POST", "/superuser/fantree/saveimage/"+fantree_id, true);
...
save_image_placeholder.addEventListener('click', function () {
    ...
    let fantree_id = get_fantree_id()
    $.ajax({
        url: "/superuser/fantree/saveimage/"+fantree_id,
        type: 'POST',
        data: {
