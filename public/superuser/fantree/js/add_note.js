...
function change_position(note_id, xpos, ypos) {
    ...
    $.ajax({
        url: "/superuser/fantree/editnoteposition/"+fantree_id,
        type: 'POST',
        data: {
            'note_id': note_id,
            'xpos': xpos,
...
function get_notes() {
    ...
    let fantree_id = get_fantree_id()
    $.ajax({
        url: "/superuser/fantree/getnotes/"+fantree_id,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            if (data.error == false) {
...
function delete_note(note_id) {
    ...
    $.ajax({
        url: "/superuser/fantree/deletenote",
        type: 'POST',
        data: {
            'note_id': note_id,
        },
...
function change_text(note_id, text) {
    ...
    let fantree_id = get_fantree_id()
    $.ajax({
        url: "/superuser/fantree/editnotetext/"+fantree_id,
        type: 'POST',
        data: {
            'note_id': note_id,
            'content': text,
...
function add_note(text, xPos, yPos) {
    ...
    let fantree_id = get_fantree_id()
    $.ajax({
        url: "/superuser/fantree/savenote/"+fantree_id,
        type: 'POST',
        data: {
            'content': text,
            'xpos': xPos,
