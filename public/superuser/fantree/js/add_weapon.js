...
document.querySelector('#addWeapon').onclick = function () {
    ...
    $.ajax({
        url: "/superuser/fantree/loadweapon/"+fantree_id,
        type: 'GET',
        encode: true,
        dataType: 'json',
        contentType: false,
...
if (deleteWeaponBtn) {
    deleteWeaponBtn.onclick = function () {
        ...
        let fantree_id = get_fantree_id()
        $.ajax({
            url: "/superuser/fantree/deleteweapon/"+fantree_id,
            type: 'POST',
            data: {},
            encode: true,
            dataType: 'json',
...
document.querySelector('#addWeaponModal #import-weapon').onclick = function () {
    ...
    let fantree_id = get_fantree_id()
    $.ajax({
        url: "/superuser/fantree/addweapon/"+fantree_id,
        type: 'POST',
        data: formData,
        encode: true,
        dataType: 'json',
...
function change_weapon_position(xpos, ypos) {
    ...
    $.ajax({
        url: "/superuser/fantree/editweaponposition/"+fantree_id,
        type: 'POST',
        data: {
            'xpos': xpos,
            'ypos': ypos
