...
function load_settings(){
    ...
    $.ajax({
        url: "/superuser/fantree/settings/"+fantree_id,
        type: 'GET',
        dataType: 'json',
...
function editChartStatus() {
    ...
    if(translateX != null && translateY != null && scale != null){
        ...
        let fantree_id = get_fantree_id()
        $.ajax({
            url: "/superuser/fantree/editchartstatus/"+fantree_id,
            type: 'POST',
            data: {
...
function applyChartStatus() {
    ...
    $.ajax({
        url: '/superuser/fantree/getchartstatus/'+fantree_id,
        method: 'GET',
        success: function (data) {
            if (data.error == false) {
...
function update_count(indis,generation){
    ...
    let fantree_id = get_fantree_id()
    $.ajax({
        url: "/superuser/fantree/updatecount/"+fantree_id,
        type: 'POST',
        data: {
            'stats': stats
        },
