...
function renderChart() {
  ...
  */
  ...
  const translateGroupY = height - 200;
...
*/
  ...
  const links = chartGroup.selectAll(".link")
    ...
    .each(function(d) {
      ...
      .attr("d", d => {
        ...
        const linkTarget = get_target_link(parent)
      ...
      .attr("d", d => {
        ...
        const linkTarget = get_target_link(parent,t=0.511)
        const linkSource = get_source_link(child)
  ...
  $(document).on("click", "#fit", function () {
    const center = d3.zoomIdentity.translate(width  / 2 , height - 200)
