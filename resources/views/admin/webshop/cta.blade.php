...
@section('content')
    ...
    <!-- Users List Table -->
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Webshop /</span> Call to action section
    </h4>
    <div class="card">
        <div class="card-body">
            <form action="{{route('admin.webshop.cta.update')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="buttonTitle" name="buttonTitle" value="{{ $data['buttonTitle'] }}" required>
                </div>
