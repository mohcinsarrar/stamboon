...
@section('page-script')
    <script src="{{ asset('superadmin/fantree/js/global_variable.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superadmin/fantree/js/utils.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superadmin/fantree/js/load_gedcom.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superadmin/fantree/js/import_gedcom.js') }}?{{ time() }}"></script>

    <script src="{{ asset('superadmin/fantree/js/settings.js') }}?{{ time() }}"></script>

    <script src="{{ asset('superadmin/fantree/js/add_parents.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superadmin/fantree/js/add_person.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superadmin/fantree/js/edit_person.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superadmin/fantree/js/show_person.js') }}?{{ time() }}"></script>

    <script src="{{ asset('superadmin/fantree/js/edit_image.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superadmin/fantree/js/delete_image.js') }}?{{ time() }}"></script>

    <script src="{{ asset('superadmin/fantree/js/delete_person.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superadmin/fantree/js/dates.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superadmin/fantree/js/d3_to_png.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superadmin/fantree/js/export.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superadmin/fantree/js/save.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superadmin/fantree/js/download.js') }}?{{ time() }}"></script>

    <script src="{{ asset('superadmin/fantree/js/add_note.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superadmin/fantree/js/add_weapon.js') }}?{{ time() }}"></script>


    <script src="{{ asset('superadmin/fantree/js/index.js') }}?{{ time() }}"></script>
    <script>
        draw_tree()
    </script>
    <script>
...
@section('content')
    ...
    @include('superadmin.fantree.settings')

    @include('superadmin.fantree.show_person')

    @include('superadmin.fantree.add_parents')

    @include('superadmin.fantree.add_person')

    @include('superadmin.fantree.edit_person')

    @include('superadmin.fantree.edit_image')

    @include('superadmin.fantree.add_note')

    @include('superadmin.fantree.add_weapon')

    @include('superadmin.fantree.export')

    @include('superadmin.fantree.download')
    ...
    <div class="alert alert-info d-flex align-items-center" role="alert">
        ...
        You are working on fanchart of user : {{ $user_name }}
    </div>
