...
@section('page-script')
    <script src="{{ asset('superuser/fantree/js/global_variable.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superuser/fantree/js/utils.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superuser/fantree/js/load_gedcom.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superuser/fantree/js/import_gedcom.js') }}?{{ time() }}"></script>

    <script src="{{ asset('superuser/fantree/js/settings.js') }}?{{ time() }}"></script>

    <script src="{{ asset('superuser/fantree/js/add_parents.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superuser/fantree/js/add_person.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superuser/fantree/js/edit_person.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superuser/fantree/js/show_person.js') }}?{{ time() }}"></script>

    <script src="{{ asset('superuser/fantree/js/edit_image.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superuser/fantree/js/delete_image.js') }}?{{ time() }}"></script>

    <script src="{{ asset('superuser/fantree/js/delete_person.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superuser/fantree/js/dates.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superuser/fantree/js/d3_to_png.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superuser/fantree/js/export.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superuser/fantree/js/save.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superuser/fantree/js/download.js') }}?{{ time() }}"></script>

    <script src="{{ asset('superuser/fantree/js/add_note.js') }}?{{ time() }}"></script>
    <script src="{{ asset('superuser/fantree/js/add_weapon.js') }}?{{ time() }}"></script>


    <script src="{{ asset('superuser/fantree/js/index.js') }}?{{ time() }}"></script>
    <script>
        draw_tree()
    </script>
    <script>
...
@section('content')
    ...
    @include('superuser.fantree.settings')

    @include('superuser.fantree.show_person')

    @include('superuser.fantree.add_parents')

    @include('superuser.fantree.add_person')

    @include('superuser.fantree.edit_person')

    @include('superuser.fantree.edit_image')

    @include('superuser.fantree.add_note')

    @include('superuser.fantree.add_weapon')

    @include('superuser.fantree.export')

    @include('superuser.fantree.download')
