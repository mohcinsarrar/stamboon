<!-- Offcanvas to add ancestor -->
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddAncestor" aria-labelledby="offcanvasAddAncestorLabel"
    data-bs-backdrop="false">
    <div class="offcanvas-header">
        <h5 id="offcanvasAddAncestorLabel" class="offcanvas-title">Add Ancestor</h5>
        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>

    <div class="offcanvas-body mx-0 flex-grow-0 pt-0 h-100">
        <h6 class="offcanvas-subtitle"></h6>
        <form class="add-new-user pt-0" id="formAddAncestor" method="POST"
            action="{{ route('users.pedigree.addancestor', $pedigree_id) }}">
            @csrf
            ...
            <div class="mb-3">
                ...
                <div class="form-check form-check-inline mt-2">
                    <input class="form-check-input living" type="radio" id="livingAddAncestor" name="status"
                        value="living">
                    <label class="form-check-label" for="livingAddAncestor"> Living</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input deceased" type="radio" id="deceasedAddAncestor" name="status"
                        value="deceased">
                    <label class="form-check-label" for="deceasedAddAncestor"> Deceased</label>
                </div>
            </div>

            <div class="mb-3">
                <label class="form-label">Date of Birth</label>
                <input type="text" name="birth_date" class="form-control date-input birth_date_add_ancestor">
            </div>

            <div class="death-container">
                <div class="mb-3">
                    <label class="form-label">Date of Death</label>
                    <input type="text" name="death_date" class="form-control date-input death_date_add_ancestor">
                </div>
            </div>
