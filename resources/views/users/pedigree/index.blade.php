...
@section('content')
    ...
    <div class="card" id="main_graph">
        <div class="row justify-content-center mt-4 d-none" id="add-first-person-container">
            <div class="col-auto">
                <button {{($has_payment == false ? 'disabled' : '')}} data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddPerson" type="button"
        ...
        <div class="card-body position-relative tools p-2" style="min-height: 600px;">
            ...
            <div class="border position-absolute p-2 bg-gray rounded" style="top:10px;left:10px" id="tools-bar">
                <div class="row  mb-2 justify-content-center" data-bs-toggle="tooltip" data-bs-placement="right" title="Upload your Gedcom file">
                    <button {{($has_payment == false ? 'disabled' : '')}} data-bs-toggle="modal" data-bs-target="#uploadFile" type="button"
                        class="btn text-white border-0 p-2 col-auto rounded-circle" ><i
                            class="ti ti-upload fs-4"></i></button>
                </div>
                <div class="row  mb-2 justify-content-center" data-bs-toggle="tooltip" data-bs-placement="right" title="Download your pedigree as Gedcom">
                ...
                <div class="row  mb-2 justify-content-center" data-bs-toggle="tooltip" data-bs-placement="right" title="Project asset">
                ...
                <div class="row  mb-2 justify-content-center" data-bs-toggle="tooltip" data-bs-placement="right" title="Center your familytree">
                ...
                <div class="row  mb-2 justify-content-center" data-bs-toggle="tooltip" data-bs-placement="right" title="Zoom In">
                ...
                <div class="row  justify-content-center" data-bs-toggle="tooltip" data-bs-placement="right" title="Zoom Out">
