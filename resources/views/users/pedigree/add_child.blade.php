...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddChild" aria-labelledby="offcanvasAddChildLabel"
    ...
    <div class="offcanvas-body mx-0 flex-grow-0 pt-0 h-100">
        ...
        <form class="add-new-user pt-0" id="formAddChild" method="POST"
            action="{{ route('users.pedigree.addchild', $pedigree_id) }}">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" name="birth_date" class="form-control date-input birth_date_add_child">
            </div>

            <div class="death-container">
                <div class="mb-3">
                    <label class="form-label">Date of Death</label>
                    <input type="text" name="death_date" class="form-control date-input death_date_add_child">
                </div>
