    ...
    <div>
        <div class="py-4">
                                    ...
                                    <table class="border-collapse border-spacing-0">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="pl-4">
                                                    <div>
                                                        <p class="whitespace-nowrap text-slate-400 text-right">Payment #
                                                        </p>
                                                        <p class="whitespace-nowrap font-bold text-main text-right">
                                                            {{ $product->payment_id }}</p>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
                        ...
                        <tr>
                            <td class="w-1/2 align-top">
                                <div class="text-sm text-neutral-600">
                                    <p class="font-bold">The Stamboom</p>
                                    <p>Chamber of Commerce (KvK) Number: 88116476</p>
                                    <p>VAT: NL004544007B83</p>
                                    <p>Beekstraat 1-d, 7311 LD</p>
                                    <p>Apeldoorn</p>
                                    <p>Netherlands, Europe</p>
                                </div>
                            </td>
                            <td class="w-1/2 align-top text-right">
                                <div class="text-sm text-neutral-600">
                                    <p class="font-bold">{{ $user_data->fullname }}</p>
                ...
                <table class="w-full border-collapse border-spacing-0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="border-b py-3 pl-2 text-right">{{ $product->price }}</td>
                            <td class="border-b py-3 pl-2 text-center">1</td>
                            <td class="border-b py-3 pl-2 text-center">{{ $product->vat }}</td>
                            <td class="border-b py-3 pl-2 text-right">{{ $product->subtotal }}</td>
                            <td class="border-b py-3 pl-2 pr-3 text-right">{{ $product->subtotal_vat }}</td>
                        </tr>
                        <tr>
                            <td colspan="7">
                                <table class="w-full border-collapse border-spacing-0">
            ...
            <div class="px-14 py-10 text-sm text-neutral-700">
                ...
                <p class="italic">It was a pleasure working with you. We hope you will keep us in mind for
                    future. Thank You!</p>
                </dvi>
