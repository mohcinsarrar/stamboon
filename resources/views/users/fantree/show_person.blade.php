    ...
    <div class="modal-body custom-modal-body" id="nodeModalBody">
        ...
        <div class="btn-group dropend">
            ...
            <ul class="dropdown-menu" style="">
                ...
                <li id="deletePhotoContainer"><a id="nodeDeletePhoto" class="dropdown-item waves-effect"
                        href="javascript:void(0);"><i class="ti ti-camera-off me-2"></i> Delete photo</a></li>
                <li><a id="nodeDelete" class="dropdown-item waves-effect" href="javascript:void(0);"><i
                            class="ti ti-trash me-2"></i> Delete</a></li>
                <form id="formDeletePerson" action="{{ route('users.fantree.delete', $fantree_id) }}" method="POST">
                    @csrf
                    <input type="hidden" name="person_id" class="person_id">
                </form>
                <li id="addParentsContainer"><a id="addParents" class="dropdown-item waves-effect"
                        href="javascript:void(0);"><i class="ti ti-user-plus me-2"></i> Add parents</a>
                </li>
            </ul>
        </div>
