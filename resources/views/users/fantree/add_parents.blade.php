    ...
    <form class="add-new-user pt-0" id="formAddParents" method="POST"
        ...
        <div class="mb-3" id="parent_type_container">
            ...
            <div class="form-check" id="father_container">
              <input name="parent_type" class="form-check-input" type="radio" value="1" id="parent_type_1"  checked="">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="birth_date"
                class="form-control date-input birth_date_add_parents" >
        </div>
        ...
        <div class="death-container">
            <div class="mb-3">
                ...
                <input type="text" name="death_date"
                    class="form-control date-input death_date_add_parents"
                    >
            </div>
