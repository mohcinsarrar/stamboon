...
class FantreeController extends Controller
{
    ...
    public function list(FantreesDataTable $dataTable){
        ...
        return $dataTable->render('superadmin.fantree.list');
    ...
    public function index(Request $request, $fantree_id){
        ...
        return view('superadmin.fantree.index', compact('fantree_id','user_name','print_types','selected_output_png','selected_output_pdf','has_payment'));
    }
